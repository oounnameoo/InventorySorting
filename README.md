...
- **Alphabetical ordering** — items are sorted A → Z by material name, with the largest stacks placed first within each material group.
...
4. Stacks are sorted **alphabetically by material name**, then by **amount descending** within each group.
